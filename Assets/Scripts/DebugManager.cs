...
public class DebugManager : MonoBehaviour
{
    ...
    [ContextMenu("Reset Level For Play")]
    public void ResetForPlay()
    {
        TurnOffTutorial();
        questDatabase.SetIDs();
        //set up player inventory
        thistlewoodSideGate.transform.localEulerAngles = new Vector3(0, -90, 0);
        thistlewoodSideGateEast.transform.localEulerAngles = new Vector3(0, -90, 0);
        thistlewoodSideRoad.SetActive(true);
